                ...
                <div class="px-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 py-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="page-title mb-0">Parish Priests</h4>
                                </div>
                                <div class="col-lg-6">
                                   <div class="d-none d-lg-block">
                                    <ol class="breadcrumb m-0 float-end">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Parish Priests</li>
                                    </ol>
                                   </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <a href="{{route('add_parish_priest')}}" style="margin-left:85%;"><button type="button" class="btn btn-primary"
    ...
    <div class="modal fade" id="deleteAddressConfirmationModal" tabindex="-1" aria-labelledby="addressModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                Do you really want to delete Parish Priests?
            </div>
