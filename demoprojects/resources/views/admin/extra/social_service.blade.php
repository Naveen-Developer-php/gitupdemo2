...
<html lang="en" data-bs-theme="light" data-menu-color="brand" data-topbar-color="light">
   ...
   @include('admin.layouts.sidemenu')
                ...
                <div class="px-3">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="py-3 py-lg-4">
                            <div class="row">
                                <div class="col-lg-6">
                                    <h4 class="page-title mb-0">Social Service</h4>
                                </div>
                                <div class="col-lg-6">
                                   <div class="d-none d-lg-block">
                                    <ol class="breadcrumb m-0 float-end">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                                        <li class="breadcrumb-item active">Social Service</li>
                                    </ol>
                                   </div>
                        ...
                        <div class="row">
                               <form method="POST" action="{{route('update_social_service',$data->id)}}">
                            @csrf
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
    ...
    quill1.root.innerHTML = `{!! $data->dexcription !!}`;
