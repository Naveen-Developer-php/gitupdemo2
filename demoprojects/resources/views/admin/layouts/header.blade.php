<head>
    ...
    <link rel="shortcut icon" href="{{asset('public/assets/images/fav.png')}}">
        <link href="{{asset('public/assets/css/upload.css')}}" rel="stylesheet" type="text/css">

    <link href="{{asset('public/assets/libs/morris.js/morris.css')}}" rel="stylesheet" type="text/css" />
