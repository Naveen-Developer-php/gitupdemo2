                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('save_banner')}}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-12">
                               <div class="brd">
                               <h4 style="margin-top: 10px; text-align: center;"> Upload Banner image<br><span style="color:#9B0000; font-size: 13px; text-align: center;">(size:400px*400px)(Max Size 1024MB) </span></h4>
