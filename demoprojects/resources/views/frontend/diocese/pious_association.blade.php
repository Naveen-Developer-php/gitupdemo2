            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active">Pious Association</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="services-info col-md-8">
                    ...
                    <h2>Pious Association</h2>
                </div>
            <p>{!! $pious->description !!}</p>
                ...
                <div class="sidebar col-md-4">
                    ...
                    <div class="sidebar-item link">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="{{route('front.pious_association')}}">Pious Association</a></li>
                        </ul>
                    </div>
                    <!-- End Single Item -->
